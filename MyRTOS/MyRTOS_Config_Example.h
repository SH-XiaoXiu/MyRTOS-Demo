...
#define MAX_TASKS_FOR_STATS             (MY_RTOS_MAX_CONCURRENT_TASKS)
#endif
...
#define MY_RTOS_HAS_TIMER_DEVICES 1
#else
#define MY_RTOS_HAS_TIMER_DEVICES 0
#endif

//======================================================================
//                AUTOMATIC INITIALIZATION & DEPENDENCY
//======================================================================
#define MY_RTOS_MODULE_INIT_LIST() \
    do { \
        MODULE_INIT_IF(1,                           Platform,       MyRTOS_Platform_Init); \
        MODULE_INIT_IF(MY_RTOS_HAS_TIMER_DEVICES,   Timer,          MyRTOS_Timer_Init); \
        MODULE_INIT_IF(MY_RTOS_USE_STDIO,           StdIO,          MyRTOS_StdIO_Init); \
        MODULE_INIT_IF(MY_RTOS_USE_LOG,             Log,            MyRTOS_Log_Init); \
        MODULE_INIT_IF(MY_RTOS_USE_SHELL,           Shell,          MyRTOS_Shell_Init); \
        MODULE_INIT_IF(MY_RTOS_USE_MONITOR,         Monitor,        MyRTOS_Monitor_Init); \
    } while(0)
...
#warning "Log Service is enabled but has no output without StdIO Service. This is a valid but likely unintended configuration."
#endif

#if (MY_RTOS_USE_SHELL == 1 && MY_RTOS_USE_STDIO == 0)
#warning "Shell Service is enabled but is non-interactive without StdIO Service. This is a valid but likely unintended configuration."
#endif

#if (MY_RTOS_USE_MONITOR == 1 && MY_RTOS_USE_STDIO == 0)
#warning "Monitor Service is enabled but has no output without StdIO Service. This is a valid but likely unintended configuration."
#endif
